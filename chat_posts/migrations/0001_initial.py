...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Censors',
            fields=[
                ('matchedtext', models.CharField(db_column='matchedText', max_length=100, primary_key=True, serialize=False)),
                ('roomname', models.CharField(db_column='roomName', max_length=30)),
                ('replacementtext', models.CharField(db_column='replacementText', max_length=100)),
            ],
            options={
                'db_table': 'Censors',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tstamp', models.DateTimeField(db_column='tStamp', primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('matchedtext', models.CharField(db_column='matchedText', max_length=100, primary_key=True, serialize=False)),
                ('height', models.DecimalField(blank=True, decimal_places=0, max_digits=4, null=True)),
                ('width', models.DecimalField(blank=True, decimal_places=0, max_digits=4, null=True)),
                ('roomname', models.CharField(db_column='roomName', max_length=30)),
        ...
        migrations.CreateModel(
            name='HandleOf',
            fields=[
                ('handlename', models.CharField(db_column='handleName', max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handlecolor', models.CharField(blank=True, db_column='handleColor', max_length=6, null=True)),
                ('textcolor', models.CharField(blank=True, db_column='textColor', max_length=6, null=True)),
                ('size', models.DecimalField(blank=True, decimal_places=0, max_digits=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('name', models.CharField(max_length=30, primary_key=True, serialize=False)),
                ('styleurl', models.TextField(blank=True, db_column='styleURL', null=True)),
            ],
            options={
                'db_table': 'Skins',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferredname', models.CharField(blank=True, db_column='preferredName', max_length=30, null=True)),
                ('realname', models.CharField(blank=True, db_column='realName', max_length=40, null=True)),
                ...
                ('defaulthandle', models.CharField(blank=True, db_column='defaultHandle', max_length=50, null=True)),
                ('defaultroom', models.CharField(blank=True, db_column='defaultRoom', max_length=30, null=True)),
                ('avatarlayout', models.CharField(db_column='avatarLayout', max_length=10)),
                ...
                ('timezoneoffset', models.DecimalField(db_column='timezoneOffset', decimal_places=0, max_digits=2)),
                ('allowskinoverride', models.IntegerField(db_column='allowSkinOverride')),
                ('scratchpadtext', models.TextField(db_column='scratchpadText')),
                ('scratchpadtime', models.DateTimeField(blank=True, db_column='scratchpadTime', null=True)),
                ...
                ('favoritevideogames', models.TextField(db_column='favoriteVideoGames')),
